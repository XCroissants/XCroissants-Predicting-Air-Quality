...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 31 11:22:25 2026
...
results_df = pd.read_csv("/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/Antonio-Prediction-Materials/Outputs-no2-no-lag/predictions_vs_actuals.csv")
model = lgb.Booster(model_file="/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/Antonio-Prediction-Materials/Outputs-no2-no-lag/lgbm_no2_model.txt")
feature_cols = json.load(open("/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/Antonio-Prediction-Materials/Outputs-no2-no-lag/feature_cols.json"))
best_params  = json.load(open("/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/Antonio-Prediction-Materials/Outputs-no2-no-lag/best_params.json"))
...
test_df_no2 = test_df.drop(columns = ['o3', 'pm10',  'Smoothed_no2', 'Smoothed_no2_L2', 'Smoothed_no2_L3', 'Smoothed_o3', 'Smoothed_o3_L2', 'Smoothed_o3_L3', 'Smoothed_pm10', 'Smoothed_pm10_L2', 'Smoothed_pm10_L3'])
...
if __name__ == "__main__":
    plot_all_diagnostics(
        ...
        target_col="no2",
        save_path="/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/Antonio-Prediction-Materials/Outputs-no2-no-lag/no2_diagnostics.png",
    )
