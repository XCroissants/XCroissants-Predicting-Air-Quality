...
train_df_pm10 = train_df.drop(columns = ['o3', 'no2',  'Smoothed_no2', 'Smoothed_no2_L2', 'Smoothed_no2_L3', 'Smoothed_o3', 'Smoothed_o3_L2', 'Smoothed_o3_L3', 'Smoothed_pm10', 'Smoothed_pm10_L2', 'Smoothed_pm10_L3'])
test_df_pm10 = test_df.drop(columns = ['o3', 'no2',  'Smoothed_no2', 'Smoothed_no2_L2', 'Smoothed_no2_L3', 'Smoothed_o3', 'Smoothed_o3_L2', 'Smoothed_o3_L3', 'Smoothed_pm10', 'Smoothed_pm10_L2', 'Smoothed_pm10_L3'])
...
import os, json
OUTPUT_DIR = "/users/eleves-b/2025/antonio.raphael/Documents/XCroissants-Predicting-Air-Quality/03. Prediction/LightGBM-Predictions/Outputs-pm10-no-lag"
