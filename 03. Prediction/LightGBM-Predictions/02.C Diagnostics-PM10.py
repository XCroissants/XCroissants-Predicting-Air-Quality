...
results_df = pd.read_csv("/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/LightGBM-Predictions/Outputs-pm10/predictions_vs_actuals.csv")
model = lgb.Booster(model_file="/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/LightGBM-Predictions/Outputs-pm10/lgbm_pm10_model.txt")
feature_cols = json.load(open("/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/LightGBM-Predictions/Outputs-pm10/feature_cols.json"))
best_params  = json.load(open("/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/LightGBM-Predictions/Outputs-pm10/best_params.json"))
...
def plot_all_diagnostics(model, test_df, feature_cols, target_col="pm10", save_path="diagnostics.png"):
    ...
    fig.suptitle(
        f"LightGBM pm10 — Test set diagnostics (unseen communes)\n"
    ...
    ax1.set_xlabel("Actual pm10")
    ax1.set_ylabel("Predicted pm10")
...
if __name__ == "__main__":
    plot_all_diagnostics(
        ...
        target_col="pm10",
        save_path="/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/LightGBM-Predictions/Outputs/pm10_diagnostics.png",
    )
