...
train_df_o3 = train_df.drop(columns = ['pm10', 'no2', 'Smoothed_no2', 'Smoothed_no2_L2', 'Smoothed_no2_L3', 'Smoothed_o3', 'Smoothed_o3_L2', 'Smoothed_o3_L3', 'Smoothed_pm10', 'Smoothed_pm10_L2', 'Smoothed_pm10_L3'])
test_df_o3 = test_df.drop(columns = ['pm10', 'no2', 'Smoothed_no2', 'Smoothed_no2_L2', 'Smoothed_no2_L3', 'Smoothed_o3', 'Smoothed_o3_L2', 'Smoothed_o3_L3', 'Smoothed_pm10', 'Smoothed_pm10_L2', 'Smoothed_pm10_L3'])
...
if __name__ == "__main__":
    ...
    test_preds = evaluate(model, test_df_o3, feature_cols, target_col="o3")

print(test_preds)

import os, json
OUTPUT_DIR = "/users/eleves-b/2025/antonio.raphael/Documents/XCroissants-Predicting-Air-Quality/03. Prediction/LightGBM-Predictions/Outputs-o3"
os.makedirs(OUTPUT_DIR, exist_ok=True)

y_true = test_df_o3["o3"].values
...
model.booster_.save_model(os.path.join(OUTPUT_DIR, "lgbm_o3_model.txt"))
