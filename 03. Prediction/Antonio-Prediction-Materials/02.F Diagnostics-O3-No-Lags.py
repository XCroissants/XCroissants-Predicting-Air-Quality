...
results_df = pd.read_csv("/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/Antonio-Prediction-Materials/Outputs-o3-no-lag/predictions_vs_actuals.csv")
model = lgb.Booster(model_file="/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/Antonio-Prediction-Materials/Outputs-o3-no-lag/lgbm_o3_model.txt")
feature_cols = json.load(open("/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/Antonio-Prediction-Materials/Outputs-o3-no-lag/feature_cols.json"))
best_params  = json.load(open("/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/Antonio-Prediction-Materials/Outputs-o3-no-lag/best_params.json"))
...
test_df_o3 = test_df.drop(columns = ['no2', 'pm10',  'Smoothed_no2', 'Smoothed_no2_L2', 'Smoothed_no2_L3', 'Smoothed_o3', 'Smoothed_o3_L2', 'Smoothed_o3_L3', 'Smoothed_pm10', 'Smoothed_pm10_L2', 'Smoothed_pm10_L3'])
...
def plot_all_diagnostics(model, test_df, feature_cols, target_col="o3", save_path="diagnostics.png"):
    ...
    fig.suptitle(
        f"LightGBM o3: No Air Pollution Lags — Test set diagnostics (unseen communes)\n"
    ...
    ax1.set_xlabel("Actual o3")
    ax1.set_ylabel("Predicted o3")
...
if __name__ == "__main__":
    plot_all_diagnostics(
        ...
        target_col="o3",
        save_path="/Users/antonioraphael/Documents/PROJECT-CLONES/XCroissants-Predicting-Air-Quality/03. Prediction/Antonio-Prediction-Materials/Outputs-o3-no-lag/o3_diagnostics.png",
    )
